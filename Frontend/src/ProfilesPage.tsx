                        ...
                        {(profile, index) => {
                            return <li id={profile.uuid} class={"list-row hover:bg-base-200 cursor-pointer transition-colors"} onclick={()=>{
                                ...
                                <div class={"flex flex-row gap-0.5 flex-shrink-0"}>
                                    <button class={"btn btn-ghost btn-xs btn-square"} title="Modify" onclick={(e) => {e.stopPropagation();}}>
                                    ...
                                    <button class={"btn btn-ghost btn-xs btn-square text-error"} title="Delete" onclick={(e) => {e.stopPropagation();}}>
